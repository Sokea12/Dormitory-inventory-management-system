...
<form method="post" action="item/add_item.php?category_id=<?= $_GET['category_id']; ?>&category_name=<?= $_GET['category_name']; ?>&category_code=<?= $_GET['category_code']; ?>&category_dsc=<?= $_GET['category_dsc']; ?>&category_created_date=<?= $_GET['category_created_date']; ?>&category_image=<?= $_GET['category_image']; ?>" enctype="multipart/form-data">
                ...
                <div class="card">
                    ...
                    <div class="card-body" >
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <a type="button" href="form_category_detail.php?category_id=<?=$_GET['category_id'];?>&category_name=<?=$_GET['category_name'];?>&category_code=<?=$_GET['category_code'];?>&category_dsc=<?=$_GET['category_dsc'];?>&category_created_date=<?=$_GET['category_created_date']; ?>&category_image=<?=$_GET['category_image'];?>" class="btn btn-light mr-2">បោះបង់</a>
...
<script>
    document.getElementById('slCategoryItemId').value = <?=$_GET['category_id'];?>;
</script>
