        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="2 4 20 20"  width="26" height="28" fill="currentColor" class="w-5 h-5">
                    ...
                    <a href="#" id="btnAddUser" class="btn btn-primary add-list" data-toggle="modal" data-target=".exampleModal" onclick="addStocks(0)">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="manege" id="manege" value="1">
...
<script>
    ...
    function addStocks(type){
        ...
        // var manege = document.getElementById("manege").value;
        // alert(manege);
