                    ...
                    <div class="card">
                        ...
                        <div class="card-body" >
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <a type="button" href="form_suppies_detail.php?sp_id=<?=$_GET['sp_id'];?>&sp_name=<?=$_GET['sp_name'];?>&sp_company=<?=$_GET['sp_company'];?>&sp_phone=<?=$_GET['sp_phone'];?>&sp_email=<?=$_GET['sp_email'];?>&sp_address=<?=$_GET['sp_address'];?>&sp_image=<?=$_GET  ['sp_image'];?>&sp_created_date=<?= $_GET['sp_created_date'];?>" class="btn btn-secondary mr-2">បោះបង់</a>
