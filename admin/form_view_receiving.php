                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="modal-header">
                            <h4 class="modal-title" id="titleItem">Received Request Details -  
                                <?php 
                                    if(isset($_GET['rqdCode'])){
                                    $code = $_GET['rqdCode'];
                                    echo $code;
                                } 
                                ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div id="table" class="table-editable">
                                        <span class="table-add float-left mb-3 mr-2">
                                            ...
                                            <h6 class="table-add float-left mb-3 mr-2">M.R Code</h6>
                                            <p>
                                                <?php if(isset($_GET['rvdCode'])){
                                                    $rvdcode = $_GET['rvdCode'];
                                                    echo $rvdcode;
                                                } ?>
                                            </p>
                                            <br>
                                        ...
                                        <table class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            $grandTotal = 0; 
                                            $num = 0;
                                            $query ="SELECT * FROM tbl_receiving_detail WHERE rvd_code = '$rvdcode'";
                                            ...
                                            if(mysqli_num_rows($query_run) > 0)
                                            {
                                                ...
                                                {
                                                    $num++;
                                                    $idrv = $row['rqd_detail_id'];
                                                    ?>
                                                <tr>
                                                    <td><?= $num; ?></td>
                                                    
                                                        <?php 
                                                            // $rvId = $row['rqd_detail_id']; 
                                                            $query ="SELECT * FROM tbl_request_detail WHERE id = '$idrv'";
                                                                $query_run = mysqli_query($conn, $query);
                                ...
                                <div class="col-lg-12">
                                    <div style="margin: 0 auto; display: flex; justify-content: center; align-items: center;" class="col-lg-4">
                                        <a href="form_receiving.php" class="btn btn-secondary mr-3 add-list" >Backe</a>
