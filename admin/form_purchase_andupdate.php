                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="checkbox d-inline-block mb-12">
                                    ...
                                    <a type="button" href="form_purchase_detaile.php?or_id=<?=$_GET['or_id'];?>&or_code=<?= $_GET['or_code'];?>&us_username=<?=$_GET['us_username'];?>&or_supplier_id=<?=$_GET['or_supplier_id']?>&sp_name=<?= $_GET['sp_name'];?>&sp_company=<?=$_GET['sp_company'];?>&or_receive=<?=$_GET['or_receive']?>&or_draft=<?=$_GET['or_draft']?>" class="btn btn-secondary mr-2">បោះបង់</a>
    ...
    function saveDataToDatabase() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // alert(message);
                if(message != 0){
                    window.location.href = "form_purchase_detaile.php?or_id=<?=$_GET['or_id'];?>&or_code=<?= $_GET['or_code'];?>&us_username=<?=$_GET['us_username'];?>&or_supplier_id=<?=$_GET['or_supplier_id']?>&sp_name=<?= $_GET['sp_name'];?>&sp_company=<?=$_GET['sp_company'];?>&or_receive=<?=$_GET['or_receive']?>&or_draft=<?=$_GET['or_draft']?>&message=" + message;
                    // href="form_purchase_detaile.php?or_id=<?=$_GET['or_id'];?>&or_code=<?= $_GET['or_code'];?>&us_username=<?=$_GET['us_username'];?>&or_supplier_id=<?=$_GET['or_supplier_id']?>&sp_name=<?= $_GET['sp_name'];?>&sp_company=<?=$_GET['sp_company'];?>&or_receive=<?=$_GET['or_receive']?>&or_draft=<?=$_GET['or_draft']?>"
                }
