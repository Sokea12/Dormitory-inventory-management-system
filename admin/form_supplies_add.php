...
<style>
  ...
  .avatar img {
    ...
    <form method="post" action="supplier/add_supplier.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>ឈ្នោះ *</label>
                                        <input type="text" id="textSuppname" name="textSuppname" min="0" class="form-control" value=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="textCompany" name="textCompany" min="0" class="form-control" value=""
                                            placeholder="សូមចូលឈ្មោះក្រុមហ៊ុន" data-errors="សូមចូលឈ្មោះក្រុមហ៊ុន" style="border: 1px solid #cbcbcb;">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group">
                                        <label>លេខទូរស័ព្ទៈ</label>
                                        <input type="text" id="textPhone" name="textPhone" min="0" class="form-control" value=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="avatar-wrapper" onclick="document.getElementById('avatarInput').click()">
                                            <div class="" style="text-align: center; width: 100%;">
                                                <i class="avatar">
                                                <input type="hidden" id="sp_image" name="sp_image" value="">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>អុីមែល៖ *</label>
                                        <input type="email" id="email" name="email" min="0" class="form-control" value="" required
